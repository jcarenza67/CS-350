...
class TemperatureMachine(StateMachine):
    ...
    def on_enter_heat(self):
        # Update lights whenever we enter heat
        redLight.on()
    ...
    def on_exit_heat(self):
        # Turn red LED off as we leave heat
        redLight.off()
    ...
    def on_enter_cool(self):
        # Update lights whenever we enter cool
        blueLight.on()
    ...
    def on_exit_cool(self):
        # Turn blue LED off as we leave cool
        blueLight.off()
    ...
    def on_enter_off(self):
       # Turn both LEDs off when thermostat is off
        redLight.off()
        blueLight.off()
    ...
    def processTempStateButton(self):
        ...
        # Cycle between off -> heat -> cool -> off
        self.cycle()
    ...
    def processTempIncButton(self):
        ...
        # Raise set point by 1 degree and refresh lights
        self.setPoint += 1
        redLight.off()
    ...
    def processTempDecButton(self):
        ...
        # Lower set point by 1 degree and refresh lights
        self.setPoint -= 1
        blueLight.off()
    ...
    def updateLights(self):
        ...
        if state == "off":
            # Both LEDs off already handled above
            return

        if state == "heat":
            if temp < self.setPoint:
                # Below set point: fade red
                redLight.pulse()
                blueLight.off()
            else:
                # At or above set point: solid red
                redLight.on()
                blueLight.off()

        elif state == "cool":
            if temp > self.setPoint:
                # Above set point: fade blue
                blueLight.pulse()
                redLight.off()
            else:
                # At or below set point: solid blue
                blueLight.on()
                redLight.off()
    ...
    def setupSerialOutput(self):
        ...
        state = self.current_state.id  # "off", "heat", or "cool"
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            # First line: date and current time
            ...
            if(altCounter < 6):
                ...
                temp_f = floor(self.getFahrenheit())
                lcd_line_2 = f"Temp:{temp_f:>4}F".ljust(16)
    
                altCounter = altCounter + 1
            else:
                # Show state and set point for 5 seconds
                state = self.current_state.id.capitalize()
                lcd_line_2 = f"{state} {self.setPoint:>3}F".ljust(16)
            ...
            if((counter % 30) == 0):
                # Send current state information over serial
